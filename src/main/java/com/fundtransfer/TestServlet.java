...
public class TestServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String apiKey =  null;//request.getParameter("apiKey");
		String sharedSecret = null;//request.getParameter("sharedSecret");
		...
		//MultipartRequest  req = new MultipartRequest(request, absoluteFilePath, 1024 * 1024 * 1024);
		//System.out.println("@@@@@@@@@@@@@@@"+req.getParameter("apiKey"));
		{
